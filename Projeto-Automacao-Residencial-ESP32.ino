...
#include <DNSServer.h>
DNSServer dns;
IPAddress local_IP(192, 168, 10, 160); //<-- Coloque aqui o Ip referente a tua rede
...
const char *pub0 = "ESP32/MinhaCasa/QuartoRobson/Ligar-DesligarTudo/Comando";
...
const char *BrokerMQTT = "192.168.10.150"; // URL do broker MQTT, aqui você coloca o endereço do Broker, seja On Line ou Local
const char *LoginDoMQTT = "xxxxxxxxxxx";  // Usuário MQTT, não pesqueça de preencher com as credenciais do seu Broker
const char *SenhaMQTT = "xxxxxxxxxxxx";     // Senha MQTT, não esqueça de preencher com as credenciais do seu Broker
const int MQTT_PORT = 1883;                // Porta padrão do MQTT
const char *clientID = "ESP32-Cliente";    // ID único do cliente, escolha o seu!
...
void publishRelayStates()
{
  mqttClient.publish(pub0, Todos ? "1" : "0");
